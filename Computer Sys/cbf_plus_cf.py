...
UxI_pred_CBF=UxF.dot(FxI)

''''user based collaborative filtering part'''
#unbias the UxI_pred from CBF
numusers,numitems=UxI_pred_CBF.shape
...
c=0
f = open('submission_CBF_plus_CF.csv', 'wt')
writer = csv.writer(f)
